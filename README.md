...
Архитектура доменных сущностей
User
...
OneToMany → progressPhotos

OneToMany → bodyMeasurements

ProgressMedia (фото прогресса)
...
type (enum: CARDIO, STRENGTH, YOGA и т.д.)
...
Exercise (предопределённый справочник упражнений)

Это как в твоем приложении на телефоне.
...
Эти упражнения не создаются пользователем, они уже есть в системе.

WorkoutExercise (связь many-to-many с данными)

Потому что у каждого упражнения в тренировке есть:
